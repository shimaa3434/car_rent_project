        ...
        <div class="col-md-4 sidebar">
          ...
          <div class="sidebar-box">
            <div class="categories">
              ...
              <li><a href="#">{{$categorie->name}} <span>({{$categorie->cars_count}})</span></a></li>
              @endforeach
            </div>
          </div>
          <div class="sidebar-box">
            <img src="{{asset('main/images/person_1.jpg')}}" alt="Free Website Template by Free-Template.co" class="img-fluid mb-4 w-50 rounded-circle">
